...
if(GENDIL_ENABLE_K3_IME_NATIVE)
  ...
  check_cxx_compiler_flag("-mcpu=spacemit-a100" GENDIL_K3_HAS_A100_CPU_FLAG)
  if(NOT GENDIL_K3_HAS_A100_CPU_FLAG)
    message(FATAL_ERROR "GENDIL_ENABLE_K3_IME_NATIVE requires compiler support for -mcpu=spacemit-a100.")
  endif()
